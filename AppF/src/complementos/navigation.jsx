...
const AppNavigator = () => {
  ...
  return (
      ...
      <Tab.Navigator initialRouteName = "Home" screenOptions = {{tabBarStyle: {height: 75, backgroundColor: color}}}>   
        ...
        <Tab.Screen name = "Profesores" component = {Horarios}
          options={({ route }) => ( {
          headerTitleAlign: 'center',
          tabBarShowLabel: false,
          backgroundColor: SECONDcolor,
          ...
          tabBarIcon: ({ focused, color, size }) => (
            <MaterialCommunityIcons name = "human-greeting" color = {'white'} size = {tamaño} />       
          ),
        ...
        <Tab.Screen name = "Blog" component = {BlogScreen}
          ...
          tabBarIcon: ({ focused, color, size }) => (
            <MaterialCommunityIcons name = "message-processing-outline" color = {'white'} size = {tamaño} />    
          ),
        ...
        <Tab.Screen name = "Talleres" component = {WorkshopRegistrationScreen}
          ...
          tabBarIcon: ({ focused, color, size }) => (
            <MaterialCommunityIcons name = "notebook-outline" color = {'white'} size = {tamaño} />       
          ),
...
<Tab.Screen name = "Notificaciones" component = {Recordatorio}
          options={({ route }) => ( {
          headerTitleAlign: 'center',
          tabBarShowLabel: false,
          backgroundColor: SECONDcolor,
          ...
          tabBarIcon: ({ focused, color, size }) => (
            <MaterialCommunityIcons name = "notification-clear-all" color = {'white'} size = {tamaño} />       
          ),
...
<Tab.Screen name = "Calendario" component = {calendario}
          ...
          tabBarIcon: ({ focused, color, size }) => (
            <MaterialCommunityIcons name = "calendar-month" color = {'white'} size = {tamaño} />       
          ),
