...
export const initialize = async (channelKey, onSuccess, onError) => {
  try {
...
export const loginUser = async (token, onSuccess, onError) => {
  try {
...
export const updatePushNotificationToken = async (token, onSuccess, onError) => {
  try {
