...
const WorkshopRegistrationScreen = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      query(collection(db, 'workshops'), orderBy('timestamp', 'asc')),
      (snapshot) => {
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.workshopContainer}>
            ...
            <Text style={styles.workshopDetails}>Lugar: {item.lugar}</Text>
            <Text style={styles.workshopDetails}>Fecha: {item.fecha}</Text>
            <Text style={styles.workshopDetails}>Hora: {item.hora}</Text>
            <Text style={styles.workshopDetails}>Asesor: {item.asesor}</Text>
